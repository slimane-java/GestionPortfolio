 ...
 */
final class Version20210504095835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, name VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, tell VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, linkdine VARCHAR(255) NOT NULL, github VARCHAR(255) NOT NULL, facebook VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
